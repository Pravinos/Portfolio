/**
 * Personal interests for the portfolio AI chat only — not shown on the site.
 * Edit the values below; the chat assistant uses this to answer casual questions.
 */
export const PERSONAL_CONTEXT = `
== PERSONAL INTERESTS ==
(Not displayed on the portfolio — available for casual conversation)
